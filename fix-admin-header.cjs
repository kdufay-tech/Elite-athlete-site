...
const old = `<button onClick={fetchData} style={s.btnGold}>↺ Refresh</button>
...
const rep = `<div style={{display:"flex",flexDirection:"column",gap:8,width:"100%"}}>
...
console.log('Done:', c.includes('flex:1,flex:1'));
